    ...
    <div className="min-h-screen bg-[#F7F7F5] flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 text-center">
          <div className="w-10 h-10 bg-purple-700 flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-xs text-gray-500 mt-1">Restricted access — authorized personnel only</p>
        </div>

        {/* Card */}
        <div className="bg-white border border-gray-200 border-t-4 border-t-purple-700 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-purple-700 hover:bg-purple-800 text-white px-6 py-3 rounded-sm font-bold text-xs uppercase tracking-widest transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-2"
            >
              {loading ? (
        ...
        <div className="text-center mt-6 space-y-2">
          <Link href="/admin/login" className="block text-xs font-mono uppercase tracking-widest text-gray-400 hover:text-gray-700 transition-colors">
            Admin Login →
          </Link>
          <Link href="/" className="block text-xs font-mono uppercase tracking-widest text-gray-400 hover:text-gray-700 transition-colors">
            ← Back to Home
          </Link>
        </div>
      </div>
